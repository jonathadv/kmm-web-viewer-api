"""
Django settings for kmmviewer project.
...
SECRET_KEY = 'mx_bn=ei8*r-be7m#2vo7qx^!slx=mv+h%)8x@tz5o%=s8_hk9'
...
WSGI_APPLICATION = 'kmmviewer.wsgi.application'
